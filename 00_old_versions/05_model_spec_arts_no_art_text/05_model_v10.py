...
class ECHR_model(nn.Module):
    ...
    def __init__(self, input_size, hidden_dim, ouput_size, pretrained_embeddings,
        ...
        self.fc_1 = nn.Linear(in_features = 5 * 2 * self.hidden_dim,
    ...
    def forward(self, X_art, X_case):
        ...
        x = torch.cat((x_case_1, x_case_2, x_case_3, x_case_4,
                       x_case_5), dim = 1)                    # batch size x (5 x hidden_dim x 2)
...
run_folder = os.path.join(os.path.split(os.getcwd())[0], '01_data', '02_runs', '09_art_13_no_text') 
