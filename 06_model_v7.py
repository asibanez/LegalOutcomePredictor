...
output_path_model = os.path.join(base_folder, '02_results', '00_no_attention', 'model.pt')
output_path_results = os.path.join(base_folder, '02_results', '00_no_attention', 'results.pkl')
